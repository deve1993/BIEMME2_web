...
const organizationSchema = {
  ...
  description:
    "Impresa generale di costruzioni. Da oltre 30 anni ci occupiamo di edilizia residenziale, industriale, restauro e ristrutturazioni.",
  foundingDate: "1993",
  address: {
    "@type": "PostalAddress",
    streetAddress: "Via Cavalier Quarto Agliardi, 18",
...
// Schema LocalBusiness per SEO locale
